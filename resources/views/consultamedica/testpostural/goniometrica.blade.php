	...
	<div class="container">
		...
		<div class="row justify-content-center">
        	...
        	<div class="col-md-12">
            	...
            	{!! Form::open(['route' => ['goniometrica.store'], 'id' => 'form']) !!}
            	<input type="hidden" name="paciente_id" value="{{$paciente->id}}">

            		<div class="card-deck mt-4">
            			<div class="card">
            				<div class="card-header">
			                    <h5>Valoracion Goniometrica</h3>
			                </div>

			                <div class="card-body">
			                	<div class="form-group">
				                	{{ Form::label('articulacionLabel', 'Articulacion') }}
	        						{{ Form::textarea('articulacion',null,['class'=>'form-control', 'rows'=>'3', 'required' => 'required']) }}
	        					</div>
			                    ...
			                    <div class="form-group">
				                	{{ Form::label('gradoMovilidadLabel', 'Grado Movilidad') }}
	        						{{ Form::textarea('gradoMovilidad',null,['class'=>'form-control', 'rows'=>'3','required' => 'required']) }}
	        					</div>
